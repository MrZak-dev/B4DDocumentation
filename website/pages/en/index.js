    ...
    const TryOut = () => (
      <Block id="try">
        {[
          {
            content:
              'We will go step by step covering every part of our code ' +
              'to understand how to customize it with your own special flavor',
            image: `${baseUrl}img/undraw_code_review.svg`,
            imageAlign: 'left',
            title: 'TO MAKE THE BEST FROM OUR SOURCE CODES',
          },
        ]}
      </Block>
    );
    ...
    const Description = () => (
      <Block background="light">
        {[
          {
            content:
              'To bring the best support to our customers, we made this website covering all our projects\' documentations',
            image: `${baseUrl}img/undraw_note_list.svg`,
            imageAlign: 'right',
            title: 'ALL DOCUMENTATIONS IN **ONE PLACE**',
          },
        ]}
      </Block>
    );
